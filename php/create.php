...
<?php if (isset($_POST['submit']) && $statement) { ?>
	<blockquote><?php echo $_POST['show_name']; ?> successfully added.</blockquote>
<?php } ?>
...
<form method="post">
	...
	<input type="number" step=0.1 min=0 max=10 name="rating" id="rating">
	<label for="ap_year">Apparition year</label>
	<select name="ap_year">
	...
	title="Enter the duration of an episode in the hh:mm:ss format">
