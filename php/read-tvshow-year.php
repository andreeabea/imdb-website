<?php if (isset($_POST['submit'])) {
	try {
		...
		$sql = "SELECT * 
				FROM tvseries
				WHERE ap_year = :ap_year";

$ap_year = $_POST['ap_year'];

$statement = $connection->prepare($sql);
$statement->bindParam(':ap_year', $ap_year, PDO::PARAM_STR);
$statement->execute();
...
if(isset($_POST['submit']))
{
	...
	<?php } else { ?>
		<blockquote>No TV shows that appeared in <?php echo escape($_POST['ap_year']); ?> found.</blockquote>
	<?php } 
} ?> 
